...
object InitialTasks {
    val list: List<Task> = listOf(
        Task(
            ...
            description = "Tổng hợp số liệu doanh thu, tăng trưởng người dùng và KPI của toàn bộ các bộ phận trong Q2.",
        ...
        Task(
            ...
            title = "Thiết kế giao diện Mobile App cho khách hàng TechCorp",
            description = "Bàn giao bộ giao diện màn hình ứng dụng quản lý logistics bao gồm: Dashboard tổng quan, Luồng quét QR nhận hàng, Bản đồ điều phối thời gian thực và Màn hình Cài đặt cá nhân.",
            status = TaskStatus.DOING,
            priority = PriorityLevel.CAO,
            category = "work",
            categoryLabel = "Công việc",
            categoryEmoji = "💼",
            dueDate = "Hôm nay (25 Tháng 6, 2025)",
            dueTime = "14:00",
            isOverdue = true,
        ...
        Task(
            ...
            description = "Tìm hiểu về quy ước đặt tên hàm, xử lý lỗi và tái cấu trúc khối lệnh.",
            status = TaskStatus.TODO,
        ...
        Task(
            ...
            description = "Mua đồ ăn sáng dinh dưỡng cho cả tuần.",
            status = TaskStatus.TODO,
